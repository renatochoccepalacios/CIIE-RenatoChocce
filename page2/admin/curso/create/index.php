...
<script src="https://kit.fontawesome.com/cfa51a9d6b.js" crossorigin="anonymous"></script>  
  ...
  <div class="back">
    ...
    <div id='left-column'>
      ...
      <input type='select' name='sede' id='sede' list='lista-sedes'>
      ...
      <input type='select' name='estados' id='estados' list='lista-estados'>
      ...
      <input type='select' name='area' id='area' list='lista-area'>
