<.?php require_once("AbstractMapper.php"); require_once("entidades/estado.php"); class EstadoDAL extends AbstractMapper{ public function cargarEstado() { $this->db_host;
    $this->db_nombre;
    $this->db_usuarios;
    $this->db_contra;
