...
if (
    $_SERVER['REQUEST_URI'] != '/SuperCIIE/page/public/login/' &&
    $_SERVER['REQUEST_URI'] != '/SuperCIIE/page/public/login/index.php' &&
    $_SERVER['REQUEST_URI'] != '/SuperCIIE/page/public/cursos/' &&
    $_SERVER['REQUEST_URI'] != '/SuperCIIE/page/public/cursos/index.php' &&
    $_SERVER['REQUEST_URI'] != '/SuperCIIE/page/public/register/' &&
    $_SERVER['REQUEST_URI'] != '/SuperCIIE/page/public/register/index.php'
) {
