...
class Cursante extends Usuario
{
    ...
    public function __construct(string $dni, string $nombre, string $apellido, string $password, string $correo, string $telefono, string $tipoCuenta, string $estado, array $niveles = [], array $areas = [])
    {
