...
function generateCertificate($idCurso, $dniAlumno, $idCertificado)
{
    ...
    <div class="container">
        <div class="text">
            ...
            <p>DNI: <strong class="dni" style="letter-spacing:1px">
                    <?= "46 087 782" ?>
                </strong>, ha asistido y aprobó el curso:</p>

            <p><strong class="course">
                    <?= '"' . $cursoNombre . '"' ?>
                </strong></p>
            <p>con una carga horaria de <strong>
                    <?= $cargaHoraria ?>
                </strong> reloj, desde el <strong>
                    <?= $fechaInicio ?>
                </strong> hasta el <strong>
                    <?= $fechaFin ?>
                </strong> con la correspondiente evaluación final.
